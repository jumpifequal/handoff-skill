...
![Handoff — continuous context across models](docs/assets/handoff-overview-en.png)

> **General logic and structure.**
...
├── scripts/
│   ├── claude_handoff_hook.js
|   ├── claude_install_hooks.js
|   ├── codex_handoff_hook.js
│   ├── codex_install_hooks.js
│   ├── codex-hooks.snippet.json
│   ├── settings.snippet.posix.json
│   ├── settings.snippet.windows-powershell.json
│   └── validate_handoff.js
```
